...
class App extends Component {
  ...
  setDisplay(num) {
    ...
    this.setState({ display: (this.state.display.length < 13) ? display : this.state.display, resetDisplay: false })
  }
  ...
  calculate() {
    ...
    this.setState({ display: String(result), temp: 0, operator: '', resetDisplay:true }, () => {console.log(this.state)});
  }
